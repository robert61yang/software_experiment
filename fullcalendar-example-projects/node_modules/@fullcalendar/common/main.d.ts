...
declare function isSingleDay(dur: Duration): boolean;
...
declare function createFormatter(input: FormatterInput, defaultSeparator?: string): DateFormatter;
...
declare class ContentHook<HookProps> extends BaseComponent<ContentHookProps<HookProps>> {
    private innerElRef;
...
declare function formatDate(dateInput: DateInput, settings?: {}): string;
declare function formatRange(startInput: DateInput, endInput: DateInput, settings: any): string;
...
declare function htmlToElement(html: string): HTMLElement;
declare function removeElement(el: HTMLElement): void;
declare function isElVisible(el: HTMLElement): boolean;
