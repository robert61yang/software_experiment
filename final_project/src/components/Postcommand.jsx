...
import './Postcommand.css';

class Postcommand extends React.Component {
    static propTypes = {
            ...
            <div className = 'row justify-content-between'>
                    <div className = 'col'>
                        <div className = 'row' id = 'commentuserrow'>
                            <i className="fas fa-user-circle fa" id = 'usericon'></i>
                    ...
                    <div className = 'col'>
                        <div className = 'row justify-content-end'>
                            ...
                            {(this.props.curname == username) &&
                                <Button className='deletecomment' color="link"  onClick={this.handleDelete} ><i className=" col fas fa-trash-alt"></i></Button> 
                            }
                        </div>
                    </div>
            </div>
    ...
    handleDelete(){
        this.props.dispatch(deleteComment(this.props.parentid, this.props.id));
    }
